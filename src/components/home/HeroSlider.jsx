...
const slides = [
  {
    ...
    badge: "India\u2019s Premier Aluminium Alloy Manufacturer",
    heading: ["Built to Perform.", "Crafted to Last."],
    subtitle: "Premium Aluminium Alloys for Every Industry",
    description:
      "From overhead conductor rods to precision wire mesh, we manufacture high-performance aluminium alloy products for power, construction, and industrial applications.",
  ...
  },
  {
    ...
    subtitle: "Precision Crafted Aluminium Alloys",
    description:
